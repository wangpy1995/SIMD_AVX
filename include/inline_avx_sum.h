...
#define sum256(a, b, i, sum) za = _mm256_loadu_si256((const __m256i *) ((a) + (i)));\
zb = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i *) ((b) + (i))));\
za0 = _mm256_cvtepi8_epi16(_mm256_extracti128_si256(za, 0x0));\
za0 = _mm256_madd_epi16(za0, zb);\
zb = _mm256_cvtepi8_epi16(_mm_loadu_si128((const __m128i *) ((b) + (i) + 16)));\
